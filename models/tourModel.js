...
// EMBEDDING THE GUIDES INTO TOURS EXAMPLE!
...
// QUERY MIDDLEWARE
// that /^find/ is a regular expression (regex) and it acts over all strings that start with find
...
tourSchema.pre('aggregate', function (next) {
  ...
  // fix for tourController.getDistances
  if (this.pipeline()[1].$geoNear) {
    const x = this.pipeline()[0];
